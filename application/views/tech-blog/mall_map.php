                ...
                <div class="page-wrapper">
                    ...
                    <div class="card">
                        <div class="card-header text-white bg-primary">
                            <h1 class="h6 mb-0 text-black-800">Map Mall</h1>
                        </div>
                        <div class="card-body">
    ...
    navigator.geolocation.getCurrentPosition(function(location) {
        ...
        var data = [
            <?php foreach ($mall as $key => $value) { ?> {
                    ...
                    "id": "<?= base_url() ?>home/datamall/<?= $value['id_mall']; ?>",
                    "lat": "<?= $value['latitude']; ?>",
                    "long": "<?= $value['longitude']; ?>",
                    "image": "<img src='<?= base_url('assets/img/mall/' . $value['m_image']) ?>' width='100%'>",
                    "nm_mall": "<?= $value['nm_mall']; ?>",
                },
            <?php } ?>
