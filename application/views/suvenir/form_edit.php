                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="form-group row">
                                <label for="isi" class="col-sm-2 col-form-label">Nama Toko Suvenir</label>
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" name="nmtksuvenir">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-2">Gambar Toko Suvenir</div>
                                <div class="class col-sm-10">
                                    <div class="class row">
                                        <div class="class col-sm-2">
                                            <img src="<?= base_url('assets/img/suvenir/') . $suvenir['s_image']; ?>" class="img-thumbnail">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-6">
        ...
        <script>
            function addMapPicker() {
                var mapCenter = ([<?= $suvenir['latitude']; ?>, <?= $suvenir['longitude']; ?>]);
                var map = L.map('map').setView([<?= $suvenir['latitude']; ?>, <?= $suvenir['longitude']; ?>], 17);
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                function get_data_edit() {
                    var id = <?= $suvenir['id_tksuvenir']; ?>;
                    $.ajax({
                        url: "<?= base_url('data/get_data_edit_suvenir'); ?>",
                        method: "POST",
                        data: {
                            id: id
                        },
                        ...
                        success: function(data) {
                            $.each(data, function(i, item) {
                                ...
                                $('[name="nmtksuvenir"]').val(data[i].nm_tksuvenir);
                                $('[name="kab"]').val(data[i].s_id_kab).trigger('change');
                                $('[name="kec"]').val(data[i].s_id_kec).trigger('change');
