                ...
                <div class="page-wrapper">
                    ...
                    <div class="card">
                        <div class="card-header text-white bg-primary">
                            <h1 class="h6 mb-0 text-black-800">Map Pasar Tradisional</h1>
                        </div>
                        <div class="card-body">
    ...
    navigator.geolocation.getCurrentPosition(function(location) {
        ...
        var data = [
            <?php foreach ($pasar as $key => $value) { ?> {
                    ...
                    "id": "<?= base_url() ?>home/datapasar/<?= $value['id_pasar']; ?>",
                    "lat": "<?= $value['latitude']; ?>",
                    "long": "<?= $value['longitude']; ?>",
                    "image": "<img src='<?= base_url('assets/img/pasar/' . $value['p_image']) ?>' width='100%'>",
                    "nm_pasar": "<?= $value['nm_pasar']; ?>",
                },
            <?php } ?>
