                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="form-group row">
                                <label for="isi" class="col-sm-2 col-form-label">Nama Pasar</label>
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" name="nmpasar">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="class col-sm-10">
                                    <div class="class row">
                                        <div class="class col-sm-2">
                                            <img src="<?= base_url('assets/img/pasar/') . $pasar['p_image']; ?>" class="img-thumbnail">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-6">
        ...
        <script>
            function addMapPicker() {
                var mapCenter = ([<?= $pasar['latitude']; ?>, <?= $pasar['longitude']; ?>]);
                var map = L.map('map').setView([<?= $pasar['latitude']; ?>, <?= $pasar['longitude']; ?>], 17);
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                function get_data_edit() {
                    var id = <?= $pasar['id_pasar']; ?>;
                    $.ajax({
                        url: "<?= base_url('data/get_data_edit_pasar'); ?>",
                        method: "POST",
                        data: {
                            id: id
                        },
                        ...
                        success: function(data) {
                            $.each(data, function(i, item) {
                                ...
                                $('[name="nmpasar"]').val(data[i].nm_pasar);
