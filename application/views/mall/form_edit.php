                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="form-group row">
                                <label for="isi" class="col-sm-2 col-form-label">Nama Mall</label>
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" name="nmmall">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-2">Gambar Mall</div>
                                <div class="class col-sm-10">
                                    <div class="class row">
                                        <div class="class col-sm-2">
                                            <img src="<?= base_url('assets/img/mall/') . $mall['m_image']; ?>" class="img-thumbnail">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-6">
        ...
        <script>
            function addMapPicker() {
                var mapCenter = ([<?= $mall['latitude']; ?>, <?= $mall['longitude']; ?>]);
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                function get_data_edit() {
                    var id = <?= $mall['id_mall']; ?>;
                    $.ajax({
                        url: "<?= base_url('data/get_data_edit_mall'); ?>",
                        method: "POST",
                        data: {
                            id: id
                        },
                        ...
                        success: function(data) {
                            $.each(data, function(i, item) {
                                ...
                                $('[name="nmmall"]').val(data[i].nm_mall);
                                $('[name="kab"]').val(data[i].m_id_kab).trigger('change');
                                $('[name="kec"]').val(data[i].m_id_kec).trigger('change');
