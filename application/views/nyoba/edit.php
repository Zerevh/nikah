            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="form-group row">
                        <label for="email" class="col-sm-2 col-form-label">Nama berita</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="namber" name="namber" value="">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="isber" class="col-sm-2 col-form-label">Isi berita</label>
                        <div class="col-sm-10">
                            <textarea class="form-control" id="isber" name="isber" rows="3"></textarea>
                        </div>
                    </div>
                    <div class="form-group row">
