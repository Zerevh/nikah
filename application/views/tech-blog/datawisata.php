            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="page-wrapper">
                    <div class="blog-title-area text-center mb-2">
                        ...
                        <span class="color-orange"><a><?= $wisata['kategori']; ?></a></span>
                    ...
                    <div class="custombox authorbox clearfix">
                        <h4 class="small-title">Keterangan Event</h4>
                        <div class="row">
                            <div class="col-lg-12 col-md-10 col-sm-10 col-xs-12">
                                <h4><a href="#"><?= $wisata['event']; ?></a></h4>
                                <p><?= $wisata['ket_event']; ?></p>
                            </div><!-- end col -->
                        </div><!-- end row -->
                    </div><!-- end author-box -->
...
<script>
    navigator.geolocation.getCurrentPosition(function(location) {
        ...
        //map view
        var map = L.map('map').setView([<?= $wisata['latitude']; ?>, <?= $wisata['longitude']; ?>], 17);
