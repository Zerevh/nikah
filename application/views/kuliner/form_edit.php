                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="form-group row">
                                <label for="isi" class="col-sm-2 col-form-label">Nama Kuliner</label>
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" name="nmkuliner">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="isi" class="col-sm-2 col-form-label">Nama Toko</label>
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" name="nmtoko">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-2">Gambar Kuliner</div>
                                <div class="class col-sm-10">
                                    <div class="class row">
                                        <div class="class col-sm-2">
                                            <img src="<?= base_url('assets/img/kuliner/') . $kuliner['k_image']; ?>" class="img-thumbnail">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-6">
        ...
        <script>
            function addMapPicker() {
                var mapCenter = ([<?= $kuliner['latitude']; ?>, <?= $kuliner['longitude']; ?>]);
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                function get_data_edit() {
                    var id = <?= $kuliner['id_kuliner']; ?>;
                    $.ajax({
                        url: "<?= base_url('data/get_data_edit_kuliner'); ?>",
                        method: "POST",
                        data: {
                            id: id
                        },
                        ...
                        success: function(data) {
                            $.each(data, function(i, item) {
                                ...
                                $('[name="nmkuliner"]').val(data[i].nm_kuliner);
                                $('[name="nmtoko"]').val(data[i].nm_toko);
                                $('[name="kab"]').val(data[i].k_id_kab).trigger('change');
                                $('[name="kec"]').val(data[i].k_id_kec).trigger('change');
                                $('[name="jln"]').val(data[i].jln);
                                $('[name="keterangan"]').val(data[i].ket);
                            });
                        }
