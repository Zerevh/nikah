                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <form action="<?= base_url('template/tbhweeding'); ?>" method="post">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control" name="nm_pria" id="nm_pria" value="<?php echo set_value('nm_pria'); ?>">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control" name="nm_wanita" id="nm_wanita" value="<?php echo set_value('nm_wanita'); ?>">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="date" class="form-control" name="tgl_acr" value="<?php echo set_value('tgl_acr'); ?>">
